create table actor (birthday date, deathday date, popularity float(53) not null, source_id integer not null, id bigint not null auto_increment, also_known_as varchar(255), biography varchar(255), name varchar(255), profile_path varchar(255), primary key (id)) engine=InnoDB;
